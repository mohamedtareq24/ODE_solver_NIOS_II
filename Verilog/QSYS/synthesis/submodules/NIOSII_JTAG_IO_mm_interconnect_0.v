// NIOSII_JTAG_IO_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module NIOSII_JTAG_IO_mm_interconnect_0 (
		...
		output wire [1:0]  clk_en_s1_address,                              //                                clk_en_s1.address
		output wire        clk_en_s1_write,                                //                                         .write
		input  wire [31:0] clk_en_s1_readdata,                             //                                         .readdata
		output wire [31:0] clk_en_s1_writedata,                            //                                         .writedata
		output wire        clk_en_s1_chipselect,                           //                                         .chipselect
		...
		output wire [1:0]  k_s1_address,                                   //                                     k_s1.address
		output wire        k_s1_write,                                     //                                         .write
		input  wire [31:0] k_s1_readdata,                                  //                                         .readdata
		output wire [31:0] k_s1_writedata,                                 //                                         .writedata
		output wire        k_s1_chipselect,                                //                                         .chipselect
		...
		output wire        rst_s1_write,                                   //                                         .write
		input  wire [31:0] rst_s1_readdata,                                //                                         .readdata
		output wire [31:0] rst_s1_writedata,                               //                                         .writedata
		output wire        rst_s1_chipselect,                              //                                         .chipselect
		output wire [1:0]  v_s1_address,                                   //                                     v_s1.address
		output wire        v_s1_write,                                     //                                         .write
		input  wire [31:0] v_s1_readdata,                                  //                                         .readdata
		output wire [31:0] v_s1_writedata,                                 //                                         .writedata
		output wire        v_s1_chipselect,                                //                                         .chipselect
		output wire [1:0]  x_s1_address,                                   //                                     x_s1.address
		output wire        x_s1_write,                                     //                                         .write
		input  wire [31:0] x_s1_readdata,                                  //                                         .readdata
		output wire [31:0] x_s1_writedata,                                 //                                         .writedata
		output wire        x_s1_chipselect                                 //                                         .chipselect
	);
	...
	wire   [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [31:0] v_s1_agent_m0_readdata;                                                             // v_s1_translator:uav_readdata -> v_s1_agent:m0_readdata
	wire         v_s1_agent_m0_waitrequest;                                                          // v_s1_translator:uav_waitrequest -> v_s1_agent:m0_waitrequest
	wire         v_s1_agent_m0_debugaccess;                                                          // v_s1_agent:m0_debugaccess -> v_s1_translator:uav_debugaccess
	wire  [15:0] v_s1_agent_m0_address;                                                              // v_s1_agent:m0_address -> v_s1_translator:uav_address
	wire   [3:0] v_s1_agent_m0_byteenable;                                                           // v_s1_agent:m0_byteenable -> v_s1_translator:uav_byteenable
	wire         v_s1_agent_m0_read;                                                                 // v_s1_agent:m0_read -> v_s1_translator:uav_read
	wire         v_s1_agent_m0_readdatavalid;                                                        // v_s1_translator:uav_readdatavalid -> v_s1_agent:m0_readdatavalid
	wire         v_s1_agent_m0_lock;                                                                 // v_s1_agent:m0_lock -> v_s1_translator:uav_lock
	wire  [31:0] v_s1_agent_m0_writedata;                                                            // v_s1_agent:m0_writedata -> v_s1_translator:uav_writedata
	wire         v_s1_agent_m0_write;                                                                // v_s1_agent:m0_write -> v_s1_translator:uav_write
	wire   [2:0] v_s1_agent_m0_burstcount;                                                           // v_s1_agent:m0_burstcount -> v_s1_translator:uav_burstcount
	wire         v_s1_agent_rf_source_valid;                                                         // v_s1_agent:rf_source_valid -> v_s1_agent_rsp_fifo:in_valid
	wire  [94:0] v_s1_agent_rf_source_data;                                                          // v_s1_agent:rf_source_data -> v_s1_agent_rsp_fifo:in_data
	wire         v_s1_agent_rf_source_ready;                                                         // v_s1_agent_rsp_fifo:in_ready -> v_s1_agent:rf_source_ready
	wire         v_s1_agent_rf_source_startofpacket;                                                 // v_s1_agent:rf_source_startofpacket -> v_s1_agent_rsp_fifo:in_startofpacket
	wire         v_s1_agent_rf_source_endofpacket;                                                   // v_s1_agent:rf_source_endofpacket -> v_s1_agent_rsp_fifo:in_endofpacket
	wire         v_s1_agent_rsp_fifo_out_valid;                                                      // v_s1_agent_rsp_fifo:out_valid -> v_s1_agent:rf_sink_valid
	wire  [94:0] v_s1_agent_rsp_fifo_out_data;                                                       // v_s1_agent_rsp_fifo:out_data -> v_s1_agent:rf_sink_data
	wire         v_s1_agent_rsp_fifo_out_ready;                                                      // v_s1_agent:rf_sink_ready -> v_s1_agent_rsp_fifo:out_ready
	wire         v_s1_agent_rsp_fifo_out_startofpacket;                                              // v_s1_agent_rsp_fifo:out_startofpacket -> v_s1_agent:rf_sink_startofpacket
	wire         v_s1_agent_rsp_fifo_out_endofpacket;                                                // v_s1_agent_rsp_fifo:out_endofpacket -> v_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> v_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> v_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // v_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> v_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> v_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> v_s1_agent:cp_endofpacket
	...
	wire  [15:0] x_s1_agent_m0_address;                                                              // x_s1_agent:m0_address -> x_s1_translator:uav_address
	...
	wire  [94:0] x_s1_agent_rf_source_data;                                                          // x_s1_agent:rf_source_data -> x_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] x_s1_agent_rsp_fifo_out_data;                                                       // x_s1_agent_rsp_fifo:out_data -> x_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> x_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> x_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // x_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> x_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> x_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> x_s1_agent:cp_endofpacket
	...
	wire  [15:0] b_s1_agent_m0_address;                                                              // b_s1_agent:m0_address -> b_s1_translator:uav_address
	...
	wire  [94:0] b_s1_agent_rf_source_data;                                                          // b_s1_agent:rf_source_data -> b_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] b_s1_agent_rsp_fifo_out_data;                                                       // b_s1_agent_rsp_fifo:out_data -> b_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> b_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> b_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // b_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> b_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> b_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> b_s1_agent:cp_endofpacket
	wire  [31:0] k_s1_agent_m0_readdata;                                                             // k_s1_translator:uav_readdata -> k_s1_agent:m0_readdata
	wire         k_s1_agent_m0_waitrequest;                                                          // k_s1_translator:uav_waitrequest -> k_s1_agent:m0_waitrequest
	wire         k_s1_agent_m0_debugaccess;                                                          // k_s1_agent:m0_debugaccess -> k_s1_translator:uav_debugaccess
	wire  [15:0] k_s1_agent_m0_address;                                                              // k_s1_agent:m0_address -> k_s1_translator:uav_address
	wire   [3:0] k_s1_agent_m0_byteenable;                                                           // k_s1_agent:m0_byteenable -> k_s1_translator:uav_byteenable
	wire         k_s1_agent_m0_read;                                                                 // k_s1_agent:m0_read -> k_s1_translator:uav_read
	wire         k_s1_agent_m0_readdatavalid;                                                        // k_s1_translator:uav_readdatavalid -> k_s1_agent:m0_readdatavalid
	wire         k_s1_agent_m0_lock;                                                                 // k_s1_agent:m0_lock -> k_s1_translator:uav_lock
	wire  [31:0] k_s1_agent_m0_writedata;                                                            // k_s1_agent:m0_writedata -> k_s1_translator:uav_writedata
	wire         k_s1_agent_m0_write;                                                                // k_s1_agent:m0_write -> k_s1_translator:uav_write
	wire   [2:0] k_s1_agent_m0_burstcount;                                                           // k_s1_agent:m0_burstcount -> k_s1_translator:uav_burstcount
	wire         k_s1_agent_rf_source_valid;                                                         // k_s1_agent:rf_source_valid -> k_s1_agent_rsp_fifo:in_valid
	wire  [94:0] k_s1_agent_rf_source_data;                                                          // k_s1_agent:rf_source_data -> k_s1_agent_rsp_fifo:in_data
	wire         k_s1_agent_rf_source_ready;                                                         // k_s1_agent_rsp_fifo:in_ready -> k_s1_agent:rf_source_ready
	wire         k_s1_agent_rf_source_startofpacket;                                                 // k_s1_agent:rf_source_startofpacket -> k_s1_agent_rsp_fifo:in_startofpacket
	wire         k_s1_agent_rf_source_endofpacket;                                                   // k_s1_agent:rf_source_endofpacket -> k_s1_agent_rsp_fifo:in_endofpacket
	wire         k_s1_agent_rsp_fifo_out_valid;                                                      // k_s1_agent_rsp_fifo:out_valid -> k_s1_agent:rf_sink_valid
	wire  [94:0] k_s1_agent_rsp_fifo_out_data;                                                       // k_s1_agent_rsp_fifo:out_data -> k_s1_agent:rf_sink_data
	wire         k_s1_agent_rsp_fifo_out_ready;                                                      // k_s1_agent:rf_sink_ready -> k_s1_agent_rsp_fifo:out_ready
	wire         k_s1_agent_rsp_fifo_out_startofpacket;                                              // k_s1_agent_rsp_fifo:out_startofpacket -> k_s1_agent:rf_sink_startofpacket
	wire         k_s1_agent_rsp_fifo_out_endofpacket;                                                // k_s1_agent_rsp_fifo:out_endofpacket -> k_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> k_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> k_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // k_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> k_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> k_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> k_s1_agent:cp_endofpacket
	...
	wire  [15:0] rst_s1_agent_m0_address;                                                            // rst_s1_agent:m0_address -> rst_s1_translator:uav_address
	...
	wire  [94:0] rst_s1_agent_rf_source_data;                                                        // rst_s1_agent:rf_source_data -> rst_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] rst_s1_agent_rsp_fifo_out_data;                                                     // rst_s1_agent_rsp_fifo:out_data -> rst_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> rst_s1_agent:cp_valid
	wire  [93:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> rst_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // rst_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> rst_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> rst_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> rst_s1_agent:cp_endofpacket
	wire  [31:0] clk_en_s1_agent_m0_readdata;                                                        // clk_en_s1_translator:uav_readdata -> clk_en_s1_agent:m0_readdata
	wire         clk_en_s1_agent_m0_waitrequest;                                                     // clk_en_s1_translator:uav_waitrequest -> clk_en_s1_agent:m0_waitrequest
	wire         clk_en_s1_agent_m0_debugaccess;                                                     // clk_en_s1_agent:m0_debugaccess -> clk_en_s1_translator:uav_debugaccess
	wire  [15:0] clk_en_s1_agent_m0_address;                                                         // clk_en_s1_agent:m0_address -> clk_en_s1_translator:uav_address
	wire   [3:0] clk_en_s1_agent_m0_byteenable;                                                      // clk_en_s1_agent:m0_byteenable -> clk_en_s1_translator:uav_byteenable
	wire         clk_en_s1_agent_m0_read;                                                            // clk_en_s1_agent:m0_read -> clk_en_s1_translator:uav_read
	wire         clk_en_s1_agent_m0_readdatavalid;                                                   // clk_en_s1_translator:uav_readdatavalid -> clk_en_s1_agent:m0_readdatavalid
	wire         clk_en_s1_agent_m0_lock;                                                            // clk_en_s1_agent:m0_lock -> clk_en_s1_translator:uav_lock
	wire  [31:0] clk_en_s1_agent_m0_writedata;                                                       // clk_en_s1_agent:m0_writedata -> clk_en_s1_translator:uav_writedata
	wire         clk_en_s1_agent_m0_write;                                                           // clk_en_s1_agent:m0_write -> clk_en_s1_translator:uav_write
	wire   [2:0] clk_en_s1_agent_m0_burstcount;                                                      // clk_en_s1_agent:m0_burstcount -> clk_en_s1_translator:uav_burstcount
	wire         clk_en_s1_agent_rf_source_valid;                                                    // clk_en_s1_agent:rf_source_valid -> clk_en_s1_agent_rsp_fifo:in_valid
	wire  [94:0] clk_en_s1_agent_rf_source_data;                                                     // clk_en_s1_agent:rf_source_data -> clk_en_s1_agent_rsp_fifo:in_data
	wire         clk_en_s1_agent_rf_source_ready;                                                    // clk_en_s1_agent_rsp_fifo:in_ready -> clk_en_s1_agent:rf_source_ready
	wire         clk_en_s1_agent_rf_source_startofpacket;                                            // clk_en_s1_agent:rf_source_startofpacket -> clk_en_s1_agent_rsp_fifo:in_startofpacket
	wire         clk_en_s1_agent_rf_source_endofpacket;                                              // clk_en_s1_agent:rf_source_endofpacket -> clk_en_s1_agent_rsp_fifo:in_endofpacket
	wire         clk_en_s1_agent_rsp_fifo_out_valid;                                                 // clk_en_s1_agent_rsp_fifo:out_valid -> clk_en_s1_agent:rf_sink_valid
	wire  [94:0] clk_en_s1_agent_rsp_fifo_out_data;                                                  // clk_en_s1_agent_rsp_fifo:out_data -> clk_en_s1_agent:rf_sink_data
	wire         clk_en_s1_agent_rsp_fifo_out_ready;                                                 // clk_en_s1_agent:rf_sink_ready -> clk_en_s1_agent_rsp_fifo:out_ready
	wire         clk_en_s1_agent_rsp_fifo_out_startofpacket;                                         // clk_en_s1_agent_rsp_fifo:out_startofpacket -> clk_en_s1_agent:rf_sink_startofpacket
	wire         clk_en_s1_agent_rsp_fifo_out_endofpacket;                                           // clk_en_s1_agent_rsp_fifo:out_endofpacket -> clk_en_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> clk_en_s1_agent:cp_valid
	wire  [93:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> clk_en_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // clk_en_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> clk_en_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> clk_en_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> clk_en_s1_agent:cp_endofpacket
	...
	wire         v_s1_agent_rp_valid;                                                                // v_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] v_s1_agent_rp_data;                                                                 // v_s1_agent:rp_data -> router_005:sink_data
	wire         v_s1_agent_rp_ready;                                                                // router_005:sink_ready -> v_s1_agent:rp_ready
	wire         v_s1_agent_rp_startofpacket;                                                        // v_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         v_s1_agent_rp_endofpacket;                                                          // v_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         x_s1_agent_rp_valid;                                                                // x_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] x_s1_agent_rp_data;                                                                 // x_s1_agent:rp_data -> router_006:sink_data
	wire         x_s1_agent_rp_ready;                                                                // router_006:sink_ready -> x_s1_agent:rp_ready
	wire         x_s1_agent_rp_startofpacket;                                                        // x_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         x_s1_agent_rp_endofpacket;                                                          // x_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         b_s1_agent_rp_valid;                                                                // b_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] b_s1_agent_rp_data;                                                                 // b_s1_agent:rp_data -> router_007:sink_data
	wire         b_s1_agent_rp_ready;                                                                // router_007:sink_ready -> b_s1_agent:rp_ready
	wire         b_s1_agent_rp_startofpacket;                                                        // b_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         b_s1_agent_rp_endofpacket;                                                          // b_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         k_s1_agent_rp_valid;                                                                // k_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] k_s1_agent_rp_data;                                                                 // k_s1_agent:rp_data -> router_008:sink_data
	wire         k_s1_agent_rp_ready;                                                                // router_008:sink_ready -> k_s1_agent:rp_ready
	wire         k_s1_agent_rp_startofpacket;                                                        // k_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         k_s1_agent_rp_endofpacket;                                                          // k_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         rst_s1_agent_rp_valid;                                                              // rst_s1_agent:rp_valid -> router_009:sink_valid
	wire  [93:0] rst_s1_agent_rp_data;                                                               // rst_s1_agent:rp_data -> router_009:sink_data
	wire         rst_s1_agent_rp_ready;                                                              // router_009:sink_ready -> rst_s1_agent:rp_ready
	wire         rst_s1_agent_rp_startofpacket;                                                      // rst_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         rst_s1_agent_rp_endofpacket;                                                        // rst_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         clk_en_s1_agent_rp_valid;                                                           // clk_en_s1_agent:rp_valid -> router_010:sink_valid
	wire  [93:0] clk_en_s1_agent_rp_data;                                                            // clk_en_s1_agent:rp_data -> router_010:sink_data
	wire         clk_en_s1_agent_rp_ready;                                                           // router_010:sink_ready -> clk_en_s1_agent:rp_ready
	wire         clk_en_s1_agent_rp_startofpacket;                                                   // clk_en_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         clk_en_s1_agent_rp_endofpacket;                                                     // clk_en_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         v_s1_agent_rdata_fifo_src_valid;                                                    // v_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] v_s1_agent_rdata_fifo_src_data;                                                     // v_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         v_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_003:in_0_ready -> v_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> v_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> v_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // v_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> v_s1_agent:rdata_fifo_sink_error
	wire         x_s1_agent_rdata_fifo_src_valid;                                                    // x_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] x_s1_agent_rdata_fifo_src_data;                                                     // x_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         x_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_004:in_0_ready -> x_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> x_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> x_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // x_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> x_s1_agent:rdata_fifo_sink_error
	wire         b_s1_agent_rdata_fifo_src_valid;                                                    // b_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] b_s1_agent_rdata_fifo_src_data;                                                     // b_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         b_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_005:in_0_ready -> b_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> b_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> b_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // b_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> b_s1_agent:rdata_fifo_sink_error
	wire         k_s1_agent_rdata_fifo_src_valid;                                                    // k_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] k_s1_agent_rdata_fifo_src_data;                                                     // k_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         k_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_006:in_0_ready -> k_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> k_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> k_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // k_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> k_s1_agent:rdata_fifo_sink_error
	wire         rst_s1_agent_rdata_fifo_src_valid;                                                  // rst_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] rst_s1_agent_rdata_fifo_src_data;                                                   // rst_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         rst_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_007:in_0_ready -> rst_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> rst_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> rst_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // rst_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> rst_s1_agent:rdata_fifo_sink_error
	wire         clk_en_s1_agent_rdata_fifo_src_valid;                                               // clk_en_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] clk_en_s1_agent_rdata_fifo_src_data;                                                // clk_en_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         clk_en_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_008:in_0_ready -> clk_en_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> clk_en_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> clk_en_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // clk_en_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> clk_en_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (v_s1_agent_m0_address),                          // avalon_universal_slave_0.address
		.uav_burstcount         (v_s1_agent_m0_burstcount),                       //                         .burstcount
		.uav_read               (v_s1_agent_m0_read),                             //                         .read
		.uav_write              (v_s1_agent_m0_write),                            //                         .write
		.uav_waitrequest        (v_s1_agent_m0_waitrequest),                      //                         .waitrequest
		.uav_readdatavalid      (v_s1_agent_m0_readdatavalid),                    //                         .readdatavalid
		.uav_byteenable         (v_s1_agent_m0_byteenable),                       //                         .byteenable
		.uav_readdata           (v_s1_agent_m0_readdata),                         //                         .readdata
		.uav_writedata          (v_s1_agent_m0_writedata),                        //                         .writedata
		.uav_lock               (v_s1_agent_m0_lock),                             //                         .lock
		.uav_debugaccess        (v_s1_agent_m0_debugaccess),                      //                         .debugaccess
		.av_address             (v_s1_address),                                   //      avalon_anti_slave_0.address
		.av_write               (v_s1_write),                                     //                         .write
		.av_readdata            (v_s1_readdata),                                  //                         .readdata
		.av_writedata           (v_s1_writedata),                                 //                         .writedata
		.av_chipselect          (v_s1_chipselect),                                //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (x_s1_write),                                     //                         .write
		.av_readdata            (x_s1_readdata),                                  //                         .readdata
		.av_writedata           (x_s1_writedata),                                 //                         .writedata
		.av_chipselect          (x_s1_chipselect),                                //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (k_s1_agent_m0_address),                          // avalon_universal_slave_0.address
		.uav_burstcount         (k_s1_agent_m0_burstcount),                       //                         .burstcount
		.uav_read               (k_s1_agent_m0_read),                             //                         .read
		.uav_write              (k_s1_agent_m0_write),                            //                         .write
		.uav_waitrequest        (k_s1_agent_m0_waitrequest),                      //                         .waitrequest
		.uav_readdatavalid      (k_s1_agent_m0_readdatavalid),                    //                         .readdatavalid
		.uav_byteenable         (k_s1_agent_m0_byteenable),                       //                         .byteenable
		.uav_readdata           (k_s1_agent_m0_readdata),                         //                         .readdata
		.uav_writedata          (k_s1_agent_m0_writedata),                        //                         .writedata
		.uav_lock               (k_s1_agent_m0_lock),                             //                         .lock
		.uav_debugaccess        (k_s1_agent_m0_debugaccess),                      //                         .debugaccess
		.av_address             (k_s1_address),                                   //      avalon_anti_slave_0.address
		.av_write               (k_s1_write),                                     //                         .write
		.av_readdata            (k_s1_readdata),                                  //                         .readdata
		.av_writedata           (k_s1_writedata),                                 //                         .writedata
		.av_chipselect          (k_s1_chipselect),                                //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (rst_s1_write),                                   //                         .write
		.av_readdata            (rst_s1_readdata),                                //                         .readdata
		.av_writedata           (rst_s1_writedata),                               //                         .writedata
		.av_chipselect          (rst_s1_chipselect),                              //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) clk_en_s1_translator (
		.clk                    (clk_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (clk_en_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (clk_en_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (clk_en_s1_agent_m0_read),                        //                         .read
		.uav_write              (clk_en_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (clk_en_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (clk_en_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (clk_en_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (clk_en_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (clk_en_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (clk_en_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (clk_en_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (clk_en_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (clk_en_s1_write),                                //                         .write
		.av_readdata            (clk_en_s1_readdata),                             //                         .readdata
		.av_writedata           (clk_en_s1_writedata),                            //                         .writedata
		.av_chipselect          (clk_en_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (v_s1_agent_m0_address),                          //              m0.address
		.m0_burstcount           (v_s1_agent_m0_burstcount),                       //                .burstcount
		.m0_byteenable           (v_s1_agent_m0_byteenable),                       //                .byteenable
		.m0_debugaccess          (v_s1_agent_m0_debugaccess),                      //                .debugaccess
		.m0_lock                 (v_s1_agent_m0_lock),                             //                .lock
		.m0_readdata             (v_s1_agent_m0_readdata),                         //                .readdata
		.m0_readdatavalid        (v_s1_agent_m0_readdatavalid),                    //                .readdatavalid
		.m0_read                 (v_s1_agent_m0_read),                             //                .read
		.m0_waitrequest          (v_s1_agent_m0_waitrequest),                      //                .waitrequest
		.m0_writedata            (v_s1_agent_m0_writedata),                        //                .writedata
		.m0_write                (v_s1_agent_m0_write),                            //                .write
		.rp_endofpacket          (v_s1_agent_rp_endofpacket),                      //              rp.endofpacket
		.rp_ready                (v_s1_agent_rp_ready),                            //                .ready
		.rp_valid                (v_s1_agent_rp_valid),                            //                .valid
		.rp_data                 (v_s1_agent_rp_data),                             //                .data
		.rp_startofpacket        (v_s1_agent_rp_startofpacket),                    //                .startofpacket
		...
		.rf_sink_ready           (v_s1_agent_rsp_fifo_out_ready),                  //         rf_sink.ready
		.rf_sink_valid           (v_s1_agent_rsp_fifo_out_valid),                  //                .valid
		.rf_sink_startofpacket   (v_s1_agent_rsp_fifo_out_startofpacket),          //                .startofpacket
		.rf_sink_endofpacket     (v_s1_agent_rsp_fifo_out_endofpacket),            //                .endofpacket
		.rf_sink_data            (v_s1_agent_rsp_fifo_out_data),                   //                .data
		.rf_source_ready         (v_s1_agent_rf_source_ready),                     //       rf_source.ready
		.rf_source_valid         (v_s1_agent_rf_source_valid),                     //                .valid
		.rf_source_startofpacket (v_s1_agent_rf_source_startofpacket),             //                .startofpacket
		.rf_source_endofpacket   (v_s1_agent_rf_source_endofpacket),               //                .endofpacket
		.rf_source_data          (v_s1_agent_rf_source_data),                      //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),              //                .error
		.rdata_fifo_src_ready    (v_s1_agent_rdata_fifo_src_ready),                //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (v_s1_agent_rdata_fifo_src_valid),                //                .valid
		.rdata_fifo_src_data     (v_s1_agent_rdata_fifo_src_data),                 //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.clk               (clk_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (v_s1_agent_rf_source_data),                      //        in.data
		.in_valid          (v_s1_agent_rf_source_valid),                     //          .valid
		.in_ready          (v_s1_agent_rf_source_ready),                     //          .ready
		.in_startofpacket  (v_s1_agent_rf_source_startofpacket),             //          .startofpacket
		.in_endofpacket    (v_s1_agent_rf_source_endofpacket),               //          .endofpacket
		.out_data          (v_s1_agent_rsp_fifo_out_data),                   //       out.data
		.out_valid         (v_s1_agent_rsp_fifo_out_valid),                  //          .valid
		.out_ready         (v_s1_agent_rsp_fifo_out_ready),                  //          .ready
		.out_startofpacket (v_s1_agent_rsp_fifo_out_startofpacket),          //          .startofpacket
		.out_endofpacket   (v_s1_agent_rsp_fifo_out_endofpacket),            //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (k_s1_agent_m0_address),                          //              m0.address
		.m0_burstcount           (k_s1_agent_m0_burstcount),                       //                .burstcount
		.m0_byteenable           (k_s1_agent_m0_byteenable),                       //                .byteenable
		.m0_debugaccess          (k_s1_agent_m0_debugaccess),                      //                .debugaccess
		.m0_lock                 (k_s1_agent_m0_lock),                             //                .lock
		.m0_readdata             (k_s1_agent_m0_readdata),                         //                .readdata
		.m0_readdatavalid        (k_s1_agent_m0_readdatavalid),                    //                .readdatavalid
		.m0_read                 (k_s1_agent_m0_read),                             //                .read
		.m0_waitrequest          (k_s1_agent_m0_waitrequest),                      //                .waitrequest
		.m0_writedata            (k_s1_agent_m0_writedata),                        //                .writedata
		.m0_write                (k_s1_agent_m0_write),                            //                .write
		.rp_endofpacket          (k_s1_agent_rp_endofpacket),                      //              rp.endofpacket
		.rp_ready                (k_s1_agent_rp_ready),                            //                .ready
		.rp_valid                (k_s1_agent_rp_valid),                            //                .valid
		.rp_data                 (k_s1_agent_rp_data),                             //                .data
		.rp_startofpacket        (k_s1_agent_rp_startofpacket),                    //                .startofpacket
		...
		.rf_sink_ready           (k_s1_agent_rsp_fifo_out_ready),                  //         rf_sink.ready
		.rf_sink_valid           (k_s1_agent_rsp_fifo_out_valid),                  //                .valid
		.rf_sink_startofpacket   (k_s1_agent_rsp_fifo_out_startofpacket),          //                .startofpacket
		.rf_sink_endofpacket     (k_s1_agent_rsp_fifo_out_endofpacket),            //                .endofpacket
		.rf_sink_data            (k_s1_agent_rsp_fifo_out_data),                   //                .data
		.rf_source_ready         (k_s1_agent_rf_source_ready),                     //       rf_source.ready
		.rf_source_valid         (k_s1_agent_rf_source_valid),                     //                .valid
		.rf_source_startofpacket (k_s1_agent_rf_source_startofpacket),             //                .startofpacket
		.rf_source_endofpacket   (k_s1_agent_rf_source_endofpacket),               //                .endofpacket
		.rf_source_data          (k_s1_agent_rf_source_data),                      //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),              //                .error
		.rdata_fifo_src_ready    (k_s1_agent_rdata_fifo_src_ready),                //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (k_s1_agent_rdata_fifo_src_valid),                //                .valid
		.rdata_fifo_src_data     (k_s1_agent_rdata_fifo_src_data),                 //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.clk               (clk_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (k_s1_agent_rf_source_data),                      //        in.data
		.in_valid          (k_s1_agent_rf_source_valid),                     //          .valid
		.in_ready          (k_s1_agent_rf_source_ready),                     //          .ready
		.in_startofpacket  (k_s1_agent_rf_source_startofpacket),             //          .startofpacket
		.in_endofpacket    (k_s1_agent_rf_source_endofpacket),               //          .endofpacket
		.out_data          (k_s1_agent_rsp_fifo_out_data),                   //       out.data
		.out_valid         (k_s1_agent_rsp_fifo_out_valid),                  //          .valid
		.out_ready         (k_s1_agent_rsp_fifo_out_ready),                  //          .ready
		.out_startofpacket (k_s1_agent_rsp_fifo_out_startofpacket),          //          .startofpacket
		.out_endofpacket   (k_s1_agent_rsp_fifo_out_endofpacket),            //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (clk_en_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (clk_en_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (clk_en_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (clk_en_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (clk_en_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (clk_en_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (clk_en_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (clk_en_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (clk_en_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (clk_en_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (clk_en_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (clk_en_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (clk_en_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (clk_en_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (clk_en_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (clk_en_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (clk_en_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (clk_en_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (clk_en_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (clk_en_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (clk_en_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (clk_en_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (clk_en_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (clk_en_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (clk_en_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (clk_en_s1_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),              //                .error
		.rdata_fifo_src_ready    (clk_en_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (clk_en_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (clk_en_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) clk_en_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (clk_en_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (clk_en_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (clk_en_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (clk_en_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (clk_en_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (clk_en_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (clk_en_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (clk_en_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (clk_en_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (clk_en_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router router (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_001 router_001 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_002 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_003 router_003 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_003 router_004 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (v_s1_agent_rp_ready),                            //      sink.ready
		.sink_valid         (v_s1_agent_rp_valid),                            //          .valid
		.sink_data          (v_s1_agent_rp_data),                             //          .data
		.sink_startofpacket (v_s1_agent_rp_startofpacket),                    //          .startofpacket
		.sink_endofpacket   (v_s1_agent_rp_endofpacket),                      //          .endofpacket
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_006 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_007 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (k_s1_agent_rp_ready),                            //      sink.ready
		.sink_valid         (k_s1_agent_rp_valid),                            //          .valid
		.sink_data          (k_s1_agent_rp_data),                             //          .data
		.sink_startofpacket (k_s1_agent_rp_startofpacket),                    //          .startofpacket
		.sink_endofpacket   (k_s1_agent_rp_endofpacket),                      //          .endofpacket
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_009 (
	...
	NIOSII_JTAG_IO_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (clk_en_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (clk_en_s1_agent_rp_valid),                       //          .valid
		.sink_data          (clk_en_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (clk_en_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (clk_en_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_JTAG_IO_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	NIOSII_JTAG_IO_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (v_s1_agent_rdata_fifo_src_data),                 //     in_0.data
		.in_0_valid     (v_s1_agent_rdata_fifo_src_valid),                //         .valid
		.in_0_ready     (v_s1_agent_rdata_fifo_src_ready),                //         .ready
	...
	NIOSII_JTAG_IO_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (k_s1_agent_rdata_fifo_src_data),                 //     in_0.data
		.in_0_valid     (k_s1_agent_rdata_fifo_src_valid),                //         .valid
		.in_0_ready     (k_s1_agent_rdata_fifo_src_ready),                //         .ready
	...
	NIOSII_JTAG_IO_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (clk_en_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (clk_en_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (clk_en_s1_agent_rdata_fifo_src_ready),           //         .ready
